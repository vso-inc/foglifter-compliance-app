...
@InputType()
class AssetNetworkDetailUpdateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => IpAddressUpdateManyWithoutAssetNetworkDetailsInput,
  })
  @ValidateNested()
  @Type(() => IpAddressUpdateManyWithoutAssetNetworkDetailsInput)
  @IsOptional()
  @Field(() => IpAddressUpdateManyWithoutAssetNetworkDetailsInput, {
    nullable: true,
  })
...
export { AssetNetworkDetailUpdateInput as AssetNetworkDetailUpdateInput };
