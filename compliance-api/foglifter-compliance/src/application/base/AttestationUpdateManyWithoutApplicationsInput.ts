...
@InputType()
class AttestationUpdateManyWithoutApplicationsInput {
...
export { AttestationUpdateManyWithoutApplicationsInput as AttestationUpdateManyWithoutApplicationsInput };
