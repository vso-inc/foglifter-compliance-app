...
@InputType()
class AttestationCreateNestedManyWithoutApplicationsInput {
...
export { AttestationCreateNestedManyWithoutApplicationsInput as AttestationCreateNestedManyWithoutApplicationsInput };
