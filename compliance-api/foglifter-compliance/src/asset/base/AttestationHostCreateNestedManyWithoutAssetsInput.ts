...
@InputType()
class AttestationHostCreateNestedManyWithoutAssetsInput {
...
export { AttestationHostCreateNestedManyWithoutAssetsInput as AttestationHostCreateNestedManyWithoutAssetsInput };
