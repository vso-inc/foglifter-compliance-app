...
@InputType()
class TssChangeLogCreateNestedManyWithoutAssetsInput {
...
export { TssChangeLogCreateNestedManyWithoutAssetsInput as TssChangeLogCreateNestedManyWithoutAssetsInput };
