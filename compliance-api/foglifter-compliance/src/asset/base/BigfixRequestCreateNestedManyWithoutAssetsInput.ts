...
@InputType()
class BigfixRequestCreateNestedManyWithoutAssetsInput {
...
export { BigfixRequestCreateNestedManyWithoutAssetsInput as BigfixRequestCreateNestedManyWithoutAssetsInput };
