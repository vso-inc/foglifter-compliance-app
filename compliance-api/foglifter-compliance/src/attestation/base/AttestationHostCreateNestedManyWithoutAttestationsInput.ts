...
@InputType()
class AttestationHostCreateNestedManyWithoutAttestationsInput {
...
export { AttestationHostCreateNestedManyWithoutAttestationsInput as AttestationHostCreateNestedManyWithoutAttestationsInput };
