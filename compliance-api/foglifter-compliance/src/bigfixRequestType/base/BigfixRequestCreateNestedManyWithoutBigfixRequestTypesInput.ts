...
@InputType()
class BigfixRequestCreateNestedManyWithoutBigfixRequestTypesInput {
...
export { BigfixRequestCreateNestedManyWithoutBigfixRequestTypesInput as BigfixRequestCreateNestedManyWithoutBigfixRequestTypesInput };
