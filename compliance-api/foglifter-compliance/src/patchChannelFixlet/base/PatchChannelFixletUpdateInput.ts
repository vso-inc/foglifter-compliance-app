...
@InputType()
class PatchChannelFixletUpdateInput {
  @ApiProperty({
    required: false,
    type: () => AttestationHostFixletUpdateManyWithoutPatchChannelFixletsInput,
  })
  @ValidateNested()
  @Type(() => AttestationHostFixletUpdateManyWithoutPatchChannelFixletsInput)
  @IsOptional()
  @Field(() => AttestationHostFixletUpdateManyWithoutPatchChannelFixletsInput, {
    nullable: true,
  })
...
export { PatchChannelFixletUpdateInput as PatchChannelFixletUpdateInput };
