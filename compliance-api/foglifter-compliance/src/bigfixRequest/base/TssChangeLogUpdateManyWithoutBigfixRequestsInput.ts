...
@InputType()
class TssChangeLogUpdateManyWithoutBigfixRequestsInput {
...
export { TssChangeLogUpdateManyWithoutBigfixRequestsInput as TssChangeLogUpdateManyWithoutBigfixRequestsInput };
