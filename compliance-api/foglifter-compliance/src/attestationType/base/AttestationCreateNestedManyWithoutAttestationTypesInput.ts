...
@InputType()
class AttestationCreateNestedManyWithoutAttestationTypesInput {
...
export { AttestationCreateNestedManyWithoutAttestationTypesInput as AttestationCreateNestedManyWithoutAttestationTypesInput };
